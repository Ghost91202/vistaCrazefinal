    ...
    return (
        <div className='h-auto bg bg-black'>
            <div className=' flex flex-col gap-10 items-center pt-20 justify-center'>
                ...
                <h1 className='sm:text-7xl font-semibold text-center'>Our UI/UX
                    <br />
                    Methodology</h1>
                <div className=' flex sticky top-24 gap-4'>
                    <span className='bg-black/20 p-5 px-16 rounded-s-full backdrop-blur-3xl'>Research</span>
                    <span className='bg-black/20 p-5 px-16 backdrop-blur-3xl'>Research</span>
                    <span className='bg-black/20 p-5 px-16 backdrop-blur-3xl'>Research</span>
                    <span className='bg-black/20 p-5 px-16 rounded-e-full backdrop-blur-3xl'>Research</span>
                </div>
                <div className='h-[400vh] sm:p-20 flex flex-col gap-10'>
                    <h1 className='sm:text-4xl font-semibold w-1/2'>Research: The Foundation of Insightful Design</h1>
                    <p className='w-2/3'>In the research phase, our goal is to derive a profound understanding of the user environment and needs through a series of targeted, high-quality research methods:</p>
                    <div className=' gap-10 grid grid-flow-row grid-cols-1 sm:grid-cols-4 '>
                        <div className='flex gap-5'>
                            ...
                            <div className='flex flex-col gap-5'>
                                <h3 className='text-lg font-semibold'>Ethnographic Studies</h3>
                    ...
                    <h1 className='sm:text-3xl font-semibold'>Advanced Data Analysis Methods
                    </h1>
                    ...
                    <div className='sm:mt-44 grid gap-10 grid-flow-row grid-cols-2'>
                        <div className='flex flex-col gap-10'>
                            <h1 className='sm:text-5xl font-semibold'>Design: Crafting User-Centric Interfaces</h1>
                        ...
                        <div className='-mt-20'>
                            <div className=' justify-between grid grid-flow-row grid-cols-1 sm:grid-cols-4 '>
                                ...
                                <div className='flex gap-5'>
                                    ...
                                    <div className='flex flex-col gap-5'>
                                        <h3 className='text-lg font-semibold'>Usability Testing
                                        </h3>
                                ...
                                <div className='flex gap-5'>
                                    ...
                                    <div className='flex flex-col gap-5'>
                                        <h3 className='text-lg font-semibold'>Focus Groups</h3>
                                ...
                                <div className='flex gap-5'>
                                    ...
                                    <div className='flex flex-col gap-5'>
                                        <h3 className='text-lg font-semibold'>Surveys and Questionnaires</h3>
                                ...
                                <div className='flex gap-5'>
                                    ...
                                    <div className='flex flex-col gap-5'>
                                        <h3 className='text-lg font-semibold'>Heatmaps</h3>
