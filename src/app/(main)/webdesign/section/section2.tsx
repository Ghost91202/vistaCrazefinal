  ...
  return (
      <div className='bg-slate-950 h-auto flex flex-col items-center pt-20 justify-center'>
          <div className=' flex flex-col gap-10 items-center justify-center'>
              ...
              <h1 className='sm:text-7xl text-2xl  font-semibold'>The Interplay of UI and UX</h1>
              ...
              <div className='flex gap-5'>
                  <Image src={UXUI} alt='Vistacraze' width={900}  className='sm:w-auto w-[60vw] sm:h-auto h-[30vh]'/>
                  <Image src={UXUI2} alt='vistacraze' width={300} className='sm:w-auto w-[20vw] sm:h-auto h-[30vh]'/>
              </div>
          </div>
    </div>
  )
