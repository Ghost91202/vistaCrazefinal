      ...
      <div className='bg-slate-950 relative z-10 h-auto flex flex-col items-center pt-20 text-white justify-center'>
          <div className=' flex flex-col gap-10 items-center justify-center'>
              ...
              <div className='flex gap-5'>
                  <Image src={UXUI} alt='Kravion ' width={800}  className='sm:w-auto w-[60vw] sm:h-auto h-[30vh]'/>
                  <Image src={UXUI2} alt='Kravion ' width={200} className='sm:w-auto w-[20vw] sm:h-auto h-[30vh]'/>
              </div>
          </div>
    </div>
  )
