...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Kravion  Digital marketing agency in Chennai</title>
        <meta name="Kravion  DIgital marketing agency" content="This is my awesome Next.js website." />
        ...
        <script type="application/ld+json">
          {JSON.stringify( {
            ...
            "@type": "WebSite",
            "name": "Kravion  Digital marketing agency in banglore ",
            ...
            <div className="  h-auto sm:pt-20 pt-10 p-5 gap-5 text-center items-center  sm:gap-40 justify-center flex flex-col  font-bold">
              <div>
                ...
                <div className="h-full w-full lg:pt-5 xl:p-20 grid grid-flow-row grid-cols-1 sm:grid-cols-3 gap-10">
                  <div className="h-full w-full bg-slate-950 group hover:bg-violet-600 flex flex-col lg:gap-4 justify-between xl:gap-20 p-5 text-white border rounded-3xl ">
