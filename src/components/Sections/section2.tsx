...
export default function Section() {
    return (
        <div className="  lg:p-20">
            <div className=" bg-violet-100 flex flex-col gap-10 rounded-2xl p-8 ">
                ...
                <div className="bg-violet-50 rounded-2xl p-10 grid grid-cols-1 justify-center lg:grid-cols-3 gap-10">
