...
const Seosection3 = (props: Props) => {
  return (
      <div className='bg-slate-950 relative z-10 h-auto text-white lg:pb-20 lg:h-auto seosection3 flex flex-col lg:p-20 p-5 gap-20 lg:gap-20 justify-between'>
          ...
          <span className='bg-gray-700/40 w-fit px-3 py-1 rounded-md'>
            Serach Engine Optimization Services
              ...
              <h1 className=' lg:text-6xl   font-semibold lg:w-2/3 text-3xl '>
                  <TextReveal text="Why choose Kravion as your SEO Company?"/>
