    ...
    return (
        <div className="relative z-10 w-full bg-gray-100 text-black flex flex-col gap-10 overflow-hidden p-5 lg:p-5 xl:p-10">
            ...
            <div className=' flex items-center gap-5 justify-center'>
                <button onClick={handlePrev} className=" left-0 top-1/2 transform -translate-y-1/2 bg-violet-600 text-white p-2 rounded-full">
                    <FaChevronLeft />
                </button>
                <button onClick={handleNext} className=" right-0 top-1/2 transform -translate-y-1/2 bg-violet-600 text-white p-2 rounded-full">
                    <FaChevronRight />
                </button>
            </div>
        </div>
