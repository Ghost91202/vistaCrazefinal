      ...
      <div className='h-auto w-full  bottom-0 -z-1 fixed footerbg text-white flex p-5 xl:p-10 flex-col gap-10'>
        ...
        <div className='border-b flex gap-5 flex-col border-gray-300 pb-5 sm:pb-10'>
          ...
          <div className='flex items-center  gap-3'>
            ...
            <Link href="https://x.com/KravionAgency?t=sXFmyicst7nrSEkY_scofQ&s=09"><TiSocialTwitter className='text-violet-500 bg-white rounded-full text-3xl p-1' /></Link>
            <Link href="/"><SlSocialPintarest className='text-white bg-red-600 rounded-full text-3xl p-1' /></Link>
            <Link href="https://www.linkedin.com/company/kravion/"><SlSocialLinkedin className='text-white bg-violet-500 rounded-md text-3xl p-1' /></Link>
            {/* <Link href="/"><SlSocialGithub className='text-white  text-2xl ' /></Link> */}
            <Link href="https://www.facebook.com/share/1B6mPsoeGJ/"><TiSocialFacebook className='text-violet-500 bg-white rounded-full text-3xl p-1' /></Link>
