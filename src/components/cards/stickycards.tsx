        ...
        <div className='bg-gray-200 font-sans text-black/80 h-auto'>
            <div className='  flex flex-col sm:flex-row '>
                ...
                <div className="sm:h-[320vh] h-auto sm:overflow-y-auto p-5 flex flex-col gap-5 pb-20  relative ">
                    ...
                    <div className='grid grid-flow-row gap-10 grid-cols-1 sm:p-0   sm:grid-cols-2 mt-10'>
                        <div className='bg-white p-5 sm:p-16   rounded-2xl h-auto w-full flex flex-col gap-10'>
                            <div>
                                ...
                                <h1 className='sm:text-4xl text-lg font-semibold sm:font-bold border-l-2 border-purple-500  group-hover:border-l-purple-600 pl-4 hover:border-l-4 group'>Web Design & Development</h1>
                            </div>
                        ...
                        <div className='bg-white p-5 sm:p-16   rounded-2xl h-auto w-full flex flex-col gap-10'>
                            ...
                            <div className=' gap-5 flex font-sans flex-col'>
                                ...
                                <div className='flex gap-2 text-black'> <Link href='/' className=' border rounded-full border-gray-300 sm:text-sm px-3 text-xs  p-1'>Brand style Guide</Link>
                        ...
                        <div className='bg-white p-5 sm:p-16 justify-between  rounded-2xl h-auto w-full flex flex-col gap-10'>
                            <div>
                    ...
                    <div className=' grid grid-flow-row grid-cols-1 h-full gap-5 sm:grid-cols-4'>
                        <div className='bg-white p-4 h-full justify-between  rounded-2xl  w-full flex flex-col gap-5'>
