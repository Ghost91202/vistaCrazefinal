      ...
      <div className=' relative z-10 flex flex-col bg-gray-50 text-black items-center justify-center p-5 sm:p-10'>
          ...
          <div className='grid grid-cols-1 gap-5 lg:pt-10 sm:grid-cols-3 xl:p-20'>
              ...
              <div className='bg-gray-100 p-4 rounded-md flex flex-col items-center justify-center'>
                  <Image src={Ngo} alt='Kravion  Industries page' className='rounded-md'/>
              ...
              <div className='bg-gray-100 p-4 rounded-md flex flex-col items-center justify-center'>
                  <Image src={Tech} alt='Kravion  Industries page' className='rounded-md'/>
                  <div className='p-5 flex flex-col gap-5'>
              ...
              <div className='bg-gray-100 p-4 rounded-md flex flex-col items-center justify-center'>
                  <Image src={Intertnmt} alt='Kravion  Industries page' className='rounded-md'/>
                  <div className='p-5 flex flex-col gap-5'>
              ...
              <div className='bg-gray-100 p-4 rounded-md flex flex-col items-center justify-center'>
                  <Image src={Real} alt='Kravion  Industries page' className='rounded-md'/>
                  <div className='p-5 flex flex-col gap-5'>
              ...
              <div className='bg-gray-100 p-4 rounded-md flex flex-col items-center justify-center'>
                  <Image src={B2B} alt='Kravion  Industries page' className='rounded-md'/>
                  <div className='p-5 flex flex-col gap-5'>
